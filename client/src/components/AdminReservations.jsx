...
const AllReservations = () => {
  const { allReservations,markReservationAsProcessed,deleteReservation } = useGetReservationInfo();
  const {allMessages,deleteMessage}=useCreateMessage()

  const handleProcessedClick = async (reservationId) => {
    await markReservationAsProcessed(reservationId);
  };
